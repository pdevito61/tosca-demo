...
if (isset($_POST['num_cpus01'])) 		$num_cpu01        = $_POST['num_cpus01'];       else  $num_cpu01        =  1;	  
...
if (isset($_POST['num_cpus02'])) 		$num_cpu02        = $_POST['num_cpus02'];       else  $num_cpu02        =  1;	  	  
...
$server2_cap_host->properties(array('disk_size' => $disk_size01, 'num_cpus' => $num_cpu01, 'mem_size' => $mem_size01));

$server2_cap_os = new tosca_capability('tosca.capabilities.OperatingSystem');
$server2_cap_os->properties(array('architecture' => $architecture01, 'type' => $type01, 'distribution' => $distribution01, 'version' => $version01));
...
$st->yaml($template_name.'-'.$template_version.'.yml');
